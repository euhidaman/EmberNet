...
_QUAL_SAMPLES = [
    dict(
        domain="OCR / Document",
        img_color=(230, 230, 255),   # light blue placeholder
    ...
    dict(
        ...
        img_color=(230, 255, 230),   # light green
    ...
    dict(
        ...
        img_color=(255, 240, 200),   # light orange
    ...
    dict(
        ...
        img_color=(255, 230, 230),   # light red
    ...
    dict(
        ...
        img_color=(240, 220, 255),   # light purple
...
def _draw_image_placeholder(ax, rgb: Tuple[int, int, int], domain: str):
    """Draw a coloured rectangle as an image thumbnail placeholder."""
...
def _render_answer_with_highlights(ax, text: str, halluc_words: List[str],
    ...
    for li, line in enumerate(lines[:5]):
        ...
        for word in words:
            ...
            if is_va and text.startswith("I might") or text.startswith("I cannot"):
                if li == 0 and x_cursor == 0.0:
                    color      = "#7b2d8b"
                    fontweight = "bold"
...
def generate(
    ...
    for row, samp in enumerate(samples):
        ...
        _draw_image_placeholder(ax_img, samp["img_color"], samp["domain"])
